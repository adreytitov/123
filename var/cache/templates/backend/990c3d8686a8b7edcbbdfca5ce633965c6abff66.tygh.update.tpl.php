<?php /* Smarty version Smarty-3.1.21, created on 2017-02-08 20:25:09
         compiled from "/home/adreytitov/html/design/backend/templates/views/pages/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:730756499589b5475e2c4b8-80675901%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '990c3d8686a8b7edcbbdfca5ce633965c6abff66' => 
    array (
      0 => '/home/adreytitov/html/design/backend/templates/views/pages/update.tpl',
      1 => 1457188866,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '730756499589b5475e2c4b8-80675901',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_589b5476023d74_95600385',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_589b5476023d74_95600385')) {function content_589b5476023d74_95600385($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/adreytitov/html/app/functions/smarty_plugins/block.hook.php';
...
$_tmp3=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["_title"] = new Smarty_variable($_tmp3.": ".((string)$_smarty_tpl->tpl_vars['page_data']->value['page']), null, 0);?>
...
?>
                <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__($_smarty_tpl->tpl_vars['_p']->value['add_name']),'href'=>"pages.add?page_type=".((string)$_smarty_tpl->tpl_vars['_k']->value)."&parent_id=".((string)$_smarty_tpl->tpl_vars['id']->value)."&come_from=".((string)$_smarty_tpl->tpl_vars['come_from']->value)));?>
</li>
            <?php } ?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['id']->value) {?>
                <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'class'=>"cm-post",'text'=>__("clone_this_page"),'href'=>"pages.clone?page_id=".((string)$_smarty_tpl->tpl_vars['id']->value)."&come_from=".((string)$_smarty_tpl->tpl_vars['come_from']->value)));?>
</li>
            <?php }?>
            <?php if ($_smarty_tpl->tpl_vars['allow_save']->value) {?>
                <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("delete_this_page"),'class'=>"cm-confirm cm-post",'href'=>"pages.delete?page_id=".((string)$_smarty_tpl->tpl_vars['id']->value)."&come_from=".((string)$_smarty_tpl->tpl_vars['come_from']->value)));?>
</li>
            <?php }?>
        <?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
