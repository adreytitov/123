<?php /* Smarty version Smarty-3.1.21, created on 2017-02-08 15:14:31
         compiled from "/home/adreytitov/html/design/backend/templates/views/profiles/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1385107496589b0ba7694b40-75322663%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3071ed598cbf03930929cd44011ee85d1b185aa9' => 
    array (
      0 => '/home/adreytitov/html/design/backend/templates/views/profiles/update.tpl',
      1 => 1457188866,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1385107496589b0ba7694b40-75322663',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_589b0ba77a81a3_81340624',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_589b0ba77a81a3_81340624')) {function content_589b0ba77a81a3_81340624($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/adreytitov/html/app/functions/smarty_plugins/block.hook.php';
?><?php
...
$_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["_title"] = new Smarty_variable($_tmp1." (".((string)$_smarty_tpl->tpl_vars['_user_desc']->value).")", null, 0);?>
<?php } else { ?>
    <?php if ($_smarty_tpl->tpl_vars['user_data']->value['firstname']) {?>
        <?php ob_start();
echo $_smarty_tpl->__("editing_profile");
$_tmp2=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["_title"] = new Smarty_variable($_tmp2.": ".((string)$_smarty_tpl->tpl_vars['user_data']->value['firstname'])." ".((string)$_smarty_tpl->tpl_vars['user_data']->value['lastname']), null, 0);?>
        <?php } elseif ($_smarty_tpl->tpl_vars['user_data']->value['b_firstname']) {?>
        <?php ob_start();
echo $_smarty_tpl->__("editing_profile");
$_tmp3=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["_title"] = new Smarty_variable($_tmp3.": ".((string)$_smarty_tpl->tpl_vars['user_data']->value['b_firstname'])." ".((string)$_smarty_tpl->tpl_vars['user_data']->value['b_lastname']), null, 0);?>
        <?php } else { ?>
        <?php ob_start();
echo $_smarty_tpl->__("editing_profile");
$_tmp4=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["_title"] = new Smarty_variable($_tmp4.": ".((string)$_smarty_tpl->tpl_vars['user_data']->value['email']), null, 0);?>
    <?php }?>
<?php }?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
    <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
        ...
        <?php if (fn_user_need_login($_smarty_tpl->tpl_vars['user_data']->value['user_type'])&&(!$_smarty_tpl->tpl_vars['runtime']->value['company_id']||$_smarty_tpl->tpl_vars['runtime']->value['company_id']==$_smarty_tpl->tpl_vars['auth']->value['company_id'])&&$_smarty_tpl->tpl_vars['user_data']->value['user_id']!=$_smarty_tpl->tpl_vars['auth']->value['user_id']&&!($_smarty_tpl->tpl_vars['user_data']->value['user_type']=='A'&&$_smarty_tpl->tpl_vars['user_data']->value['is_root']=='Y'&&!$_smarty_tpl->tpl_vars['user_data']->value['company_id'])) {?>
            ...
            <li class="divider"></li>
            <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("delete"),'class'=>"cm-confirm cm-post",'href'=>"profiles.delete?user_id=".((string)$_smarty_tpl->tpl_vars['id']->value)."&redirect_url=".((string)$_smarty_tpl->tpl_vars['redirect_url']->value)));?>
</li>
        <?php }?>
