<?php /* Smarty version Smarty-3.1.21, created on 2017-02-10 13:12:09
         compiled from "/home/adreytitov/html/design/backend/templates/views/companies/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1530714412589d91f9114ef2-78050238%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0bb8440f66f14c33c589b982e069d98719649868' => 
    array (
      0 => '/home/adreytitov/html/design/backend/templates/views/companies/update.tpl',
      1 => 1457188866,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1530714412589d91f9114ef2-78050238',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_589d91f9289710_36783804',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_589d91f9289710_36783804')) {function content_589d91f9289710_36783804($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/adreytitov/html/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_unpuny')) include '/home/adreytitov/html/app/functions/smarty_plugins/modifier.unpuny.php';
...
?><?php
fn_preload_lang_vars(array('use_existing_store','store','none','recommended','information','vendor_name','storefront_url','ttc_storefront_url','secure_storefront_url','design','store_theme','goto_theme_configuration','status','active','pending','new','disabled','language','create_administrator_account','contact_information','contact_information','email','phone','url','fax','shipping_address','shipping_address','address','city','country','select_country','state','select_state','zip_postal_code','settings','company','description','redirect_customer_from_storefront','entry_page','none','index','all_pages','countries','shipping_methods','available_for_vendor','disabled','no_data','menu','view_vendor_products','view_vendor_categories','view_vendor_users','view_vendor_orders','delete','editing_vendor','new_vendor'));
?>
...
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>__($_smarty_tpl->tpl_vars['object_data']->value['tooltip'])), 0);
}?>:</label>
                <div class="controls">
...
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>__("ttc_storefront_url")), 0);?>
:</label>
    <div class="controls">
...
<?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>   
    <?php if ($_smarty_tpl->tpl_vars['id']->value) {?>
        ...
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"companies:tools_list")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"companies:tools_list"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
            ...
            <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("delete"),'class'=>"cm-confirm cm-post",'href'=>"companies.delete?company_id= ".((string)$_smarty_tpl->tpl_vars['id']->value)." "));?>
</li>
...
<?php if ($_smarty_tpl->tpl_vars['id']->value) {?>
    <?php ob_start();
echo $_smarty_tpl->__("editing_vendor");
