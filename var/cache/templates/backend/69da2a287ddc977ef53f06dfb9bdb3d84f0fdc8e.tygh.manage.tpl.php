<?php /* Smarty version Smarty-3.1.21, created on 2017-02-10 13:43:22
         compiled from "/home/adreytitov/html/design/backend/templates/views/statuses/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1828440530589d994abe39f2-54603297%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '69da2a287ddc977ef53f06dfb9bdb3d84f0fdc8e' => 
    array (
      0 => '/home/adreytitov/html/design/backend/templates/views/statuses/manage.tpl',
      1 => 1457188866,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1828440530589d994abe39f2-54603297',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_589d994ac3e936_55089329',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_589d994ac3e936_55089329')) {function content_589d994ac3e936_55089329($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/home/adreytitov/html/app/functions/smarty_plugins/function.script.php';
...
?><?php
fn_preload_lang_vars(array('editing_status','no_data','new_status','add_status','add_status','unable_to_create_status','maximum_number_of_statuses_reached'));
?>
...
$_tmp1=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/object_group.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>mb_strtolower($_smarty_tpl->tpl_vars['s']->value['status'], 'UTF-8'),'text'=>$_smarty_tpl->tpl_vars['s']->value['description'],'href'=>"statuses.update?status=".((string)$_smarty_tpl->tpl_vars['s']->value['status'])."&type=".((string)$_smarty_tpl->tpl_vars['type']->value),'href_delete'=>$_smarty_tpl->tpl_vars['cur_href_delete']->value,'delete_target_id'=>"statuses_list,actions_panel",'header_text'=>$_tmp1.": ".((string)$_smarty_tpl->tpl_vars['s']->value['description']),'no_table'=>true,'nostatus'=>true,'tool_items'=>Smarty::$_smarty_vars['capture']['tool_items'],'extra_data'=>Smarty::$_smarty_vars['capture']['extra_data']), 0);?>
