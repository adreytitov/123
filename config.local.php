...
$config['db_name'] = 'adreytitov_1';
$config['db_user'] = 'adreytitov_1';
$config['db_password'] = 'adreytitov_1';
...
$config['http_host'] = 'adreytitov.s20.wh1.su';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'adreytitov.s20.wh1.su';
$config['https_path'] = '';
