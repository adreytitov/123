    ...
    protected function _importSuppliers()
    {
        ...
        if (!empty($companies)) {
            ...
            foreach ($shippings as $supplier_id => $shipping_ids) {
                db_query("INSERT INTO ?:supplier_links SELECT ?i as supplier_id, shipping_id as object_id, 'S' as object_type FROM ?:shippings WHERE company_id = 0 AND shipping_id IN (?n)", $supplier_id, $shipping_ids);
            }
        }
    }
