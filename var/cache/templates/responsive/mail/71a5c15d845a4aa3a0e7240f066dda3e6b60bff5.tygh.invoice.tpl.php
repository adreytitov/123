<?php /* Smarty version Smarty-3.1.21, created on 2017-02-10 18:45:29
         compiled from "/home/adreytitov/html/design/themes/responsive/mail/templates/orders/invoice.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1689353074589de0197dcf96-48335485%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '71a5c15d845a4aa3a0e7240f066dda3e6b60bff5' => 
    array (
      0 => '/home/adreytitov/html/design/themes/responsive/mail/templates/orders/invoice.tpl',
      1 => 1486555461,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1689353074589de0197dcf96-48335485',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_589de019ac8d09_61170013',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_589de019ac8d09_61170013')) {function content_589de019ac8d09_61170013($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/adreytitov/html/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_replace')) include '/home/adreytitov/html/app/lib/vendor/smarty/smarty/libs/plugins/modifier.replace.php';
if (!is_callable('smarty_modifier_date_format')) include '/home/adreytitov/html/app/functions/smarty_plugins/modifier.date_format.php';
if (!is_callable('smarty_function_set_id')) include '/home/adreytitov/html/app/functions/smarty_plugins/function.set_id.php';
?><?php
fn_preload_lang_vars(array('invoice','invoice','credit_memo','credit_memo','order_details','invoice_title','phone1_label','phone2_label','fax','web_site','email','order','status','date','payment_method','shipping_method','tracking_number','customer','phone','fax','company','url','bill_to','ship_to','product','quantity','unit_price','discount','tax','subtotal','deleted_product','sku','free','free','subtotal','including_discount','order_discount','coupon','taxes','included','tax_exempt','payment_surcharge','shipping_cost','total_cost','customer_notes','invoice','invoice','credit_memo','credit_memo','order_details','invoice_title','phone1_label','phone2_label','fax','web_site','email','order','status','date','payment_method','shipping_method','tracking_number','customer','phone','fax','company','url','bill_to','ship_to','product','quantity','unit_price','discount','tax','subtotal','deleted_product','sku','free','free','subtotal','including_discount','order_discount','coupon','taxes','included','tax_exempt','payment_surcharge','shipping_cost','total_cost','customer_notes'));
?>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="main-table" style="direction: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language_direction']->value, ENT_QUOTES, 'UTF-8');?>
; height: 100%; background-color: #f4f6f8; font-size: 12px; font-family: Arial;">
<tr>
    <td align="center" style="width: 100%; height: 100%;">
    <table cellpadding="0" cellspacing="0" border="0" style="direction: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language_direction']->value, ENT_QUOTES, 'UTF-8');?>
; width: 602px; table-layout: fixed; margin: 24px 0 24px 0;">
    <tr>
...
; padding: 27px 0px 0px 0px; border-bottom: 1px solid #868686; margin-bottom: 8px;">
            <tr>
...
" /></td>
                <td width="100%" >&nbsp;</td>
                <td valign="bottom" style="text-align: right;  font: bold 26px Arial; text-transform: uppercase;  margin: 0px;"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['order_header']->value)===null||$tmp==='' ? $_smarty_tpl->__("invoice_title") : $tmp), ENT_QUOTES, 'UTF-8');?>
</td>
            </tr>
            </table>
...
"><?php echo smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->tpl_vars['company_data']->value['company_orders_department'],",","<br>")," ",'');?>
</a></td>
                    </tr>
                    <?php }?>
                    </table>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['s_phone'], ENT_QUOTES, 'UTF-8');?>
 <?php }?>
            ...
            <table width="100%" cellpadding="0" cellspacing="1" style="direction: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language_direction']->value, ENT_QUOTES, 'UTF-8');?>
...
;">
            <tr>
                <td align="right">
                <table border="0" style="direction: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language_direction']->value, ENT_QUOTES, 'UTF-8');?>
...
if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A") {?><span class="cm-template-box template-box" data-ca-te-template="orders/invoice.tpl" id="<?php echo smarty_function_set_id(array('name'=>"orders/invoice.tpl"),$_smarty_tpl);?>
...
<?php if ($_smarty_tpl->tpl_vars['status_settings']->value['appearance_type']=="I"&&$_smarty_tpl->tpl_vars['order_info']->value['doc_ids'][$_smarty_tpl->tpl_vars['status_settings']->value['appearance_type']]) {?>
    <?php ob_start();
echo $_smarty_tpl->__("invoice");
$_tmp3=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["doc_id_text"] = new Smarty_variable($_tmp3." #".((string)$_smarty_tpl->tpl_vars['order_info']->value['doc_ids'][$_smarty_tpl->tpl_vars['status_settings']->value['appearance_type']]), null, 0);?>
<?php } elseif ($_smarty_tpl->tpl_vars['status_settings']->value['appearance_type']=="C"&&$_smarty_tpl->tpl_vars['order_info']->value['doc_ids'][$_smarty_tpl->tpl_vars['status_settings']->value['appearance_type']]) {?>
    <?php ob_start();
echo $_smarty_tpl->__("credit_memo");
$_tmp4=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["doc_id_text"] = new Smarty_variable($_tmp4." #".((string)$_smarty_tpl->tpl_vars['order_info']->value['doc_ids'][$_smarty_tpl->tpl_vars['status_settings']->value['appearance_type']]), null, 0);?>
    <?php $_smarty_tpl->tpl_vars["order_header"] = new Smarty_variable($_smarty_tpl->__("credit_memo"), null, 0);?>
<?php } elseif ($_smarty_tpl->tpl_vars['status_settings']->value['appearance_type']=="O") {?>
    <?php $_smarty_tpl->tpl_vars["order_header"] = new Smarty_variable($_smarty_tpl->__("order_details"), null, 0);?>
<?php }?>
