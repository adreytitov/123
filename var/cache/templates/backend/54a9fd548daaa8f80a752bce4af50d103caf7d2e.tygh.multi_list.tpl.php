<?php /* Smarty version Smarty-3.1.21, created on 2017-02-08 15:20:48
         compiled from "/home/adreytitov/html/design/backend/templates/views/static_data/components/multi_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1912553354589b0d20d29d31-90702315%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '54a9fd548daaa8f80a752bce4af50d103caf7d2e' => 
    array (
      0 => '/home/adreytitov/html/design/backend/templates/views/static_data/components/multi_list.tpl',
      1 => 1457188866,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1912553354589b0d20d29d31-90702315',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_589b0d20d68129_89054534',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_589b0d20d68129_89054534')) {function content_589b0d20d68129_89054534($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/adreytitov/html/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
?><?php
...
$_tmp2=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('act'=>"edit",'text'=>$_tmp2.": ".((string)$_smarty_tpl->tpl_vars['item']->value['descr']),'link_text'=>__("edit"),'id'=>"group".((string)$_smarty_tpl->tpl_vars['item']->value['param_id']),'link_class'=>"tool-link",'no_icon_link'=>true,'href'=>"static_data.update?param_id=".((string)$_smarty_tpl->tpl_vars['item']->value['param_id'])."&section=".((string)$_smarty_tpl->tpl_vars['section']->value)."&".((string)$_smarty_tpl->tpl_vars['owner_condition']->value)), 0);?>
                    ...
                    <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("delete"),'href'=>"static_data.delete?param_id=".((string)$_smarty_tpl->tpl_vars['item']->value['param_id'])."&section=".((string)$_smarty_tpl->tpl_vars['section']->value)."&".((string)$_smarty_tpl->tpl_vars['owner_condition']->value),'class'=>"cm-confirm cm-ajax cm-post cm-delete-row",'data'=>array('data-ca-target-id'=>'static_data_list')));?>
</li>
