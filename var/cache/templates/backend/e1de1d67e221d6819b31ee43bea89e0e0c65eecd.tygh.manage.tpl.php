<?php /* Smarty version Smarty-3.1.21, created on 2017-02-10 13:12:04
         compiled from "/home/adreytitov/html/design/backend/templates/views/companies/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1115096488589d91f45ba2d7-60280372%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e1de1d67e221d6819b31ee43bea89e0e0c65eecd' => 
    array (
      0 => '/home/adreytitov/html/design/backend/templates/views/companies/manage.tpl',
      1 => 1457188866,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1115096488589d91f45ba2d7-60280372',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_589d91f46e5014_37314167',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_589d91f46e5014_37314167')) {function content_589d91f46e5014_37314167($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/adreytitov/html/app/functions/smarty_plugins/block.hook.php';
    ...
    <td class="nowrap">
        ...
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"companies:list_extra_links")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"companies:list_extra_links"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
            ...
            <?php if (!$_smarty_tpl->tpl_vars['runtime']->value['company_id']&&fn_check_view_permissions("companies.update","POST")) {?>
                ...
                <?php } else { ?>
                    <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'class'=>"cm-confirm cm-post",'href'=>"companies.delete?company_id=".((string)$_smarty_tpl->tpl_vars['company']->value['company_id'])."&redirect_url=".((string)$_smarty_tpl->tpl_vars['return_current_url']->value),'text'=>__("delete")));?>
</li>
                <?php }?>
            <?php }?>
