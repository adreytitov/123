<?php /* Smarty version Smarty-3.1.21, created on 2017-02-10 18:29:16
         compiled from "/home/adreytitov/html/design/backend/templates/views/products/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1137178602589ddc4c54b4e9-67639501%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b1eaca169e8280577abb031acb20fb2648e483ea' => 
    array (
      0 => '/home/adreytitov/html/design/backend/templates/views/products/update.tpl',
      1 => 1457188866,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1137178602589ddc4c54b4e9-67639501',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_589ddc4c77c700_06150541',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_589ddc4c77c700_06150541')) {function content_589ddc4c77c700_06150541($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/adreytitov/html/app/functions/smarty_plugins/block.hook.php';
                    ...
                    <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
                        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:update_tools_list")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:update_tools_list"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['view_uri']->value) {?>
                                ...
                                <li class="divider"></li>
                            <?php }?>
                            <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("clone"),'class'=>"cm-post",'href'=>"products.clone?product_id=".((string)$_smarty_tpl->tpl_vars['id']->value)));?>
</li>
                            <?php if ($_smarty_tpl->tpl_vars['allow_save']->value) {?>
                                <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("delete"),'class'=>"cm-confirm cm-post",'href'=>"products.delete?product_id=".((string)$_smarty_tpl->tpl_vars['id']->value)));?>
</li>
                            <?php }?>
...
$_tmp5=ob_get_clean();?><?php echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_tmp5.": ".((string)$_smarty_tpl->tpl_vars['product_data']->value['product'])), ENT_QUOTES, 'UTF-8');?>
