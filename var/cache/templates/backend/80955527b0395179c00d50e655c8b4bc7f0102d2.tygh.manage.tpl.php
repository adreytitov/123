<?php /* Smarty version Smarty-3.1.21, created on 2017-02-10 21:54:45
         compiled from "/home/adreytitov/html/design/backend/templates/addons/seo/views/seo_redirects/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1480042509589e0c754ca1d3-44286949%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '80955527b0395179c00d50e655c8b4bc7f0102d2' => 
    array (
      0 => '/home/adreytitov/html/design/backend/templates/addons/seo/views/seo_redirects/manage.tpl',
      1 => 1457188866,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1480042509589e0c754ca1d3-44286949',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_589e0c75550b28_40553798',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_589e0c75550b28_40553798')) {function content_589e0c75550b28_40553798($_smarty_tpl) {?><?php if (!is_callable('smarty_function_include_ext')) include '/home/adreytitov/html/app/functions/smarty_plugins/function.include_ext.php';
?><?php
...
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>__("tt_addons_seo_views_seo_redirects_manage_seo.old_url")), 0);?>
:</label>
    <div class="controls">
...
" target="_blank"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['redirect']->value['parsed_url'], ENT_QUOTES, 'UTF-8');?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['addons']->value['seo']['single_url']!="Y"&&sizeof($_smarty_tpl->tpl_vars['languages']->value)>1) {?>
    <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['languages']->value[$_smarty_tpl->tpl_vars['redirect']->value['lang_code']]['name'], ENT_QUOTES, 'UTF-8');?>
</td>
    <?php }?>    
    <td class="nowrap">
        ...
        <div class="hidden-tools">
            <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
                <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("delete"),'class'=>"cm-confirm cm-post",'href'=>"seo_redirects.delete?redirect_id=".((string)$_smarty_tpl->tpl_vars['redirect']->value['redirect_id'])));?>
</li>
            <?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
