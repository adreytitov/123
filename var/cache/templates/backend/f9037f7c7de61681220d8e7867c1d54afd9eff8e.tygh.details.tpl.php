<?php /* Smarty version Smarty-3.1.21, created on 2017-02-10 18:45:48
         compiled from "/home/adreytitov/html/design/backend/templates/views/orders/details.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1087205154589de02c20efc7-14963235%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f9037f7c7de61681220d8e7867c1d54afd9eff8e' => 
    array (
      0 => '/home/adreytitov/html/design/backend/templates/views/orders/details.tpl',
      1 => 1457188866,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1087205154589de02c20efc7-14963235',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_589de02c44c100_74944107',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_589de02c44c100_74944107')) {function content_589de02c44c100_74944107($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/adreytitov/html/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_function_math')) include '/home/adreytitov/html/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['shipment']->value['tracking_number']) {?>
                                    <div class="control-group">
                                        <?php if ($_smarty_tpl->tpl_vars['shipment']->value['carrier']) {?>
                                            <?php $_smarty_tpl->tpl_vars['carrier'] = new Smarty_variable($_smarty_tpl->tpl_vars['shipment']->value['carrier'], null, 0);?>
                                        <?php }?>
                                        <div class="control-label">
                                            <?php if ($_smarty_tpl->tpl_vars['carrier']->value) {?>
                                                <?php echo $_smarty_tpl->__("carrier_".((string)$_smarty_tpl->tpl_vars['carrier']->value));?>
...
"></a>
                                            <?php }?>
                                            <?php if ($_smarty_tpl->tpl_vars['carrier']->value) {?>
                                                <a href="<?php echo $_smarty_tpl->tpl_vars['shipment']->value['tracking_url'];?>
...
&nbsp;(<?php echo htmlspecialchars(count($_smarty_tpl->tpl_vars['order_info']->value['shipment_ids']), ENT_QUOTES, 'UTF-8');?>
                        ...
                        <?php } else { ?>
                            <?php if ($_smarty_tpl->tpl_vars['shipments']->value[$_smarty_tpl->tpl_vars['shipping']->value['group_key']]['shipment_id']) {?>
...
][tracking_number]" size="45" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipments']->value[$_smarty_tpl->tpl_vars['shipping']->value['group_key']]['tracking_number'], ENT_QUOTES, 'UTF-8');?>
" />
                                    <input type="hidden" name="update_shipping[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['group_key'], ENT_QUOTES, 'UTF-8');?>
][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipment_id']->value, ENT_QUOTES, 'UTF-8');?>
][shipping_id]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping_id'], ENT_QUOTES, 'UTF-8');?>
" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo $_smarty_tpl->getSubTemplate ("common/carriers.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>"carrier_key",'meta'=>"input-small",'name'=>"update_shipping[".((string)$_smarty_tpl->tpl_vars['shipping']->value['group_key'])."][".((string)$_smarty_tpl->tpl_vars['shipment_id']->value)."][carrier]",'carrier'=>$_smarty_tpl->tpl_vars['shipments']->value[$_smarty_tpl->tpl_vars['shipping']->value['group_key']]['carrier']), 0);?>
