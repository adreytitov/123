<?php /* Smarty version Smarty-3.1.21, created on 2017-02-11 12:02:00
         compiled from "/home/adreytitov/html/design/backend/templates/views/promotions/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1142571329589ed308ac8a21-61716292%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4dc4eb1e177bcb48e961c55580ded9c33e7fdcf6' => 
    array (
      0 => '/home/adreytitov/html/design/backend/templates/views/promotions/update.tpl',
      1 => 1457188866,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1142571329589ed308ac8a21-61716292',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_589ed308b80a28_77178621',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_589ed308b80a28_77178621')) {function content_589ed308b80a28_77178621($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/home/adreytitov/html/app/functions/smarty_plugins/function.script.php';
...
?><?php
fn_preload_lang_vars(array('name','detailed_description','short_description','use_avail_period','avail_from','avail_till','priority','stop_other_rules','tt_views_promotions_update_stop_other_rules','delete','new_promotion','editing_promotion'));
?>
...
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>__("tt_views_promotions_update_stop_other_rules")), 0);?>
</label>
        <div class="controls">
...
<?php if ($_smarty_tpl->tpl_vars['id']->value) {?>
    <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
        <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("delete"),'class'=>"cm-confirm cm-post",'href'=>"promotions.delete?promotion_id=".((string)$_smarty_tpl->tpl_vars['id']->value)));?>
</li>
    <?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
...
<?php } else { ?>
    <?php ob_start();
echo $_smarty_tpl->__("editing_promotion");
$_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["title"] = new Smarty_variable($_tmp1.":&nbsp;".((string)$_smarty_tpl->tpl_vars['promotion_data']->value['name']), null, 0);?>
<?php }?>
