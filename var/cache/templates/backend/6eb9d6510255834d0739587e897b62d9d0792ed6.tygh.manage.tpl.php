<?php /* Smarty version Smarty-3.1.21, created on 2017-02-10 22:06:11
         compiled from "/home/adreytitov/html/design/backend/templates/views/profiles/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:612024995589e0f2350c615-91622587%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6eb9d6510255834d0739587e897b62d9d0792ed6' => 
    array (
      0 => '/home/adreytitov/html/design/backend/templates/views/profiles/manage.tpl',
      1 => 1457188866,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '612024995589e0f2350c615-91622587',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_589e0f2364c864_38910113',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_589e0f2364c864_38910113')) {function content_589e0f2364c864_38910113($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/adreytitov/html/app/functions/smarty_plugins/block.hook.php';
...
?><?php
fn_preload_lang_vars(array('id','person_name','email','registered','type','status','view','administrator','vendor_administrator','customer','affiliate','view_all_orders','act_on_behalf','edit','delete','notify_user','no_data','export_selected','users','add_user'));
?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user']->value['email'], ENT_QUOTES, 'UTF-8');?>
    ...
    <td class="row-status"><?php if ($_smarty_tpl->tpl_vars['user']->value['user_type']=="A") {
    ...
    <td class="right nowrap">
        <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
            ...
            <?php $_smarty_tpl->_capture_stack[0][] = array("tools_delete", null, null); ob_start(); ?>
                <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("delete"),'class'=>"cm-confirm cm-post",'href'=>"profiles.delete?user_id=".((string)$_smarty_tpl->tpl_vars['user']->value['user_id'])."&redirect_url=".((string)$_smarty_tpl->tpl_vars['return_current_url']->value)));?>
</li>
