<?php /* Smarty version Smarty-3.1.21, created on 2017-02-08 15:16:51
         compiled from "/home/adreytitov/html/design/backend/templates/views/themes/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2038771554589b0c339d3eb1-28630370%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ac0786543adb5414350fb3c91631b1c99bfb8e35' => 
    array (
      0 => '/home/adreytitov/html/design/backend/templates/views/themes/manage.tpl',
      1 => 1457188866,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2038771554589b0c339d3eb1-28630370',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_589b0c33b2d0f7_98445768',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_589b0c33b2d0f7_98445768')) {function content_589b0c33b2d0f7_98445768($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/home/adreytitov/html/app/functions/smarty_plugins/function.script.php';
...
if (!is_callable('smarty_function_split')) include '/home/adreytitov/html/app/functions/smarty_plugins/function.split.php';
...
">
            <table class="table table-condensed">
                <thead>
                    <tr>
                        <th><?php echo $_smarty_tpl->__("overwrite");?>
</th>
                        <th></th>
                        <th class="right"><?php echo $_smarty_tpl->__("value");?>
</th>
                    </tr>
                </thead>
                <tbody>
...
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value['value'], ENT_QUOTES, 'UTF-8');?>
" checked>
                            </td>
                            <td>
                            ...
                            <td class="right">
                                <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value['value'], ENT_QUOTES, 'UTF-8');?>
...
"><?php echo $_smarty_tpl->__("cancel");?>
                ...
                <button class="btn btn-primary" type="submit" name="allow_overwrite" value="Y"><?php echo $_smarty_tpl->__("submit");?>
</button>
            </div>
        </form>
    </div>
...
$_smarty_tpl->tpl_vars['styles_descr']->value[$_smarty_tpl->tpl_vars['style']->value['style_id']] = $_smarty_tpl->tpl_vars['style']->value['name'];?>
                        ...
                        <td class="right btn-toolbar">
                            ...
                            <?php }?>
                            <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_href'=>"customization.update_mode?type=theme_editor&status=enable&s_layout=".((string)$_smarty_tpl->tpl_vars['available_layout']->value['layout_id']),'but_text'=>__("theme_editor"),'but_role'=>"action",'but_meta'=>$_smarty_tpl->tpl_vars['is_default']->value,'but_target'=>"_blank"), 0);?>
    ...
    <?php } else { ?>
        <div class="theme-no-styles">
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_href'=>"customization.update_mode?type=theme_editor&status=enable",'but_text'=>__("theme_editor"),'but_role'=>"action",'but_meta'=>"btn-primary cm-post"), 0);?>
...
: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['style']->value['name'], ENT_QUOTES, 'UTF-8');?>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['style']->value['style_id']!=$_smarty_tpl->tpl_vars['layout']->value['style_id']) {?>
                                <div class="theme-use">
