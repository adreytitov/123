<?php /* Smarty version Smarty-3.1.21, created on 2017-02-10 18:44:11
         compiled from "/home/adreytitov/html/design/themes/responsive/templates/views/checkout/components/final_section.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1918372979589ddfcb16f522-82912993%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8c923370f868fe3cfe79dfc858ce7854771b3b38' => 
    array (
      0 => '/home/adreytitov/html/design/themes/responsive/templates/views/checkout/components/final_section.tpl',
      1 => 1486555461,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1918372979589ddfcb16f522-82912993',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_589ddfcb1c2fe4_87979529',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_589ddfcb1c2fe4_87979529')) {function content_589ddfcb1c2fe4_87979529($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/adreytitov/html/app/functions/smarty_plugins/block.hook.php';
...
<?php if ($_smarty_tpl->tpl_vars['show_place_order']->value) {?>
    ...
    <div class="clearfix <?php if (!$_smarty_tpl->tpl_vars['is_payment_step']->value) {?> checkout__block<?php }?>">
        ...
        <div class="clearfix">
            ...
            <?php if ($_smarty_tpl->tpl_vars['recalculate']->value&&$_smarty_tpl->tpl_vars['cart']->value['shipping_required']) {?>
                ...
                <div class="ty-checkout-buttons cm-checkout-recalculate-buttons hidden">
                    <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_meta'=>"ty-btn__secondary cm-checkout-recalculate",'but_name'=>"dispatch[checkout.update_steps]",'but_text'=>__("recalculate_shipping_cost")), 0);?>
